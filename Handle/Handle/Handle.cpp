...
void ConcreteHandleA::HandleRequest()
{
	...
	{
		cout << "ConcreteHandleA 我把处理权给后续节点......" << endl;
		this->GetSuccessor()->HandleRequest();
	}
	else
	{
		cout << "ConcreteHandleA 没有后续了，我必须自己处理......" << endl;
	}
}
...
void ConcreteHandleB::HandleRequest()
{
	if (this->GetSuccessor() != 0)
	{
		cout << "ConcreteHandleB 我把处理权给后续节点......" << endl;
		this->GetSuccessor()->HandleRequest();
	}
	else
	{
		cout << "ConcreteHandleB 没有后续了，我必须自己处理......" << endl;
	}
}